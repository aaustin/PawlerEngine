...
void SetupSensors(void) {
	...
	ADC10CTL2 = ADC10RES;
	ADC10MCTL0 = ADC10SREF_0 + ADC10INCH_14; //set the A/D ref voltage
...
__interrupt void ADC10_ISR(void) {
	switch(__even_in_range(ADC10IV,ADC10IV_ADC10IFG)) {
		case ADC10IV_ADC10IFG:
			...
			//ADC10CTL0 &= ~ADC10SC;
			if (ADC10MCTL0 & ADC10INCH_1 && ADC10MCTL0 & ADC10INCH_8 && ADC10MCTL0 & ADC10INCH_4) {
				ADCResultY = ADC10MEM0;

				ADC10CTL0 &= ~ADC10ENC;
				ADC10MCTL0 = ADC10INCH_12;
				ADC10CTL0 |= ADC10ENC | ADC10SC;
			} else if (ADC10MCTL0 & ADC10INCH_2 && ADC10MCTL0 & ADC10INCH_8 && ADC10MCTL0 & ADC10INCH_4) {
				ADCResultZ = ADC10MEM0;

				ADC10CTL0 &= ~ADC10ENC;
				ADC10MCTL0 = ADC10INCH_13;
				ADC10CTL0 |= ADC10ENC | ADC10SC;
			} else if (ADC10MCTL0 & ADC10INCH_8 && ADC10MCTL0 & ADC10INCH_4) {
